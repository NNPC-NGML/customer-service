...
class CustomerContractTypeService
{
    ...
    public function update(CustomerContractType $contractType, array $data): bool
    {
        $validatedData = $this->validate($data, $contractType->id, true);
        return $contractType->update($validatedData);
    }

    public function delete(CustomerContractType $contractType): bool
    {
