...
class CustomerDdqSubGroupControllerTest extends TestCase
{
     ...
     * @return void
     */
    public function test_it_can_create_a_ddq_subgroup()
    {
     ...
     * @return void
     */
    public function test_it_can_list_all_ddq_subgroups()
    {
        $this->actingAsAuthenticatedTestUser();
     ...
     * @return void
     */
    public function test_it_can_view_a_single_ddq_subgroup()
    {
        $this->actingAsAuthenticatedTestUser();
        $subgroup = CustomerDdqSubGroup::factory()->create();
     ...
     * @return void
     */
    public function test_it_can_update_a_ddq_subgroup()
    {
        $this->actingAsAuthenticatedTestUser();
        $subgroup = CustomerDdqSubGroup::factory()->create([
            'title' => 'Old Subgroup',
     ...
     * @return void
     */
    public function test_it_can_delete_a_ddq_subgroup()
    {
        $this->actingAsAuthenticatedTestUser();
        $subgroup = CustomerDdqSubGroup::factory()->create();
